...
echo 'add a remote pseudo for the openapr3.0-final-ver repository'

git remote add origin https://complexmathguy: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@github.com/complexmathguy/openapr3.0-final-ver

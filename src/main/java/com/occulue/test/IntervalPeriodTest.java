...
public class IntervalPeriodTest {
  ...
  protected CreateIntervalPeriodCommand generateNewCommand() {
    CreateIntervalPeriodCommand command = new CreateIntervalPeriodCommand(null, new Date(), "", "");
  ...
  protected UpdateIntervalPeriodCommand generateUpdateCommand() {
    UpdateIntervalPeriodCommand command = new UpdateIntervalPeriodCommand(null, new Date(), "", "");
